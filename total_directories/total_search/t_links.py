class T_Links:
    def __init__(self,month=None,day=None,year=None,unique_part=None,id_=None,elif_id_=None,h_link=None,h_listlink=None,h_gallerylink=None,rg=None,page_num=None):
